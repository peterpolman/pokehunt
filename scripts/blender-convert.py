"""Headless Blender import + glTF export.

Usage:
    blender --background --python scripts/blender-convert.py -- <input> <output.glb>

Supports .obj and .fbx (Blender 5.x dropped Collada).
"""
...
if len(argv) != 2:
    print('usage: blender --background --python blender-convert.py -- <input> <output>',
          flush=True)
    raise SystemExit(2)
